...
1. Изучили синтаксис работы с векторами и матрицами. Научились задавать векторы, вертикальные векторы, матрицы и выполнять действия над ними. Применяли команды:
- cross
- dot
- inv
- norm
...
2. Построили несколько графиков (рис. [-@fig:001]) применяя команды:
- plot
- hold
- grid
- axis
